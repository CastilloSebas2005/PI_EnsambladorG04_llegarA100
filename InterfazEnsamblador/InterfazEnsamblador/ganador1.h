...
namespace InterfazEnsamblador {
	...
	/// Resumen de ganador1
	/// </summary>
	public ref class ganador1 : public System::Windows::Forms::Form
	{
	public:
		ganador1(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(116, 55);
			this->label1->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(249, 43);
			this->label1->TabIndex = 38;
			this->label1->Text = L"Gana Jugador 1";
			...
			this->button1->Location = System::Drawing::Point(9, 125);
			...
			this->button1->Click += gcnew System::EventHandler(this, &ganador1::button1_Click);
			// 
			// exit
			// 
			...
			this->exit->Location = System::Drawing::Point(253, 125);
			...
			this->exit->Click += gcnew System::EventHandler(this, &ganador1::exit_Click);
			// 
			// ganador1
			// 
			...
			this->ClientSize = System::Drawing::Size(491, 209);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->exit);
			this->Controls->Add(this->label1);
			this->Name = L"ganador1";
			this->Text = L"ganador1";
